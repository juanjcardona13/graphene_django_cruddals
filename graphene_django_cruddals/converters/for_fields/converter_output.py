...
@convert_django_field_to_output.register(
    GenericRel
)  # Representa otro tipo OneToMany, Lo que seria un ForeignKey
...
def convert_field_to_list_or_connection(field, registry: RegistryGlobal):
    ...
    def dynamic_type():
        ...
        if registries_for_model is not None and "cruddals" in registries_for_model:
            ...
            return django_search_field(
                _type=search_field._type,
                args=search_field.args,
