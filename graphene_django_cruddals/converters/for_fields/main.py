...
def convert_django_field_with_choices_to_output(
    field: DjangoField, registry: RegistryGlobal, convert_choices_to_enum=True
):
...
def convert_django_field_without_choices_to_filter_input(
    ...
    registry.register_field(
        field, TypeRegistryForFieldEnum.INPUT_FOR_SEARCH.value, converted
    )
    return converted
...
def convert_django_field_without_choices_to_order_by_input(
    ...
    registry.register_field(
        field, TypeRegistryForFieldEnum.INPUT_FOR_ORDER_BY.value, converted
    )
    return converted
