...
class ModelA(models.Model):
    ...
    char_field_with_default = models.CharField(max_length=100, default="char_field_with_default")
    char_field_with_description = models.CharField(max_length=100, help_text="char_field_with_description")

    choice_field_required = models.CharField(max_length=100, choices=[("a", "A"), ("b", "B")])
    choice_field_not_editable = models.CharField(max_length=100, choices=[("a", "A"), ("b", "B")], editable=False)
    choice_field_nullable = models.CharField(max_length=100, choices=[("a", "A"), ("b", "B")], null=True, blank=True)
    choice_field_with_default = models.CharField(max_length=100, choices=[("a", "A"), ("b", "B")], default="a")
    choice_field_with_description = models.CharField(max_length=100, choices=[("a", "A"), ("b", "B")], help_text="choice_field_with_description")
    ...
    decimal_field_not_editable = models.DecimalField(max_digits=10, decimal_places=2, editable=False)
    decimal_field_nullable = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    decimal_field_with_default = models.DecimalField(max_digits=10, decimal_places=2, default=Decimal(0.0))
    decimal_field_with_description = models.DecimalField(max_digits=10, decimal_places=2, help_text="decimal_field_with_description")
    ...
    foreign_key_field_required = models.ForeignKey( "ModelA", on_delete=models.CASCADE, related_name="foreign_key_related", )
    foreign_key_field_nullable = models.ForeignKey( "ModelA", on_delete=models.CASCADE, null=True, blank=True, related_name="foreign_key_nullable_related", )
    foreign_key_field_with_description = models.ForeignKey( "ModelA", on_delete=models.CASCADE, related_name="foreign_key_with_description_related", help_text="foreign_key_field_with_description" )
    foreign_key_field_without_related_name = models.ForeignKey( "ModelA", on_delete=models.CASCADE, related_name="+" )

    one_to_one_field_required = models.OneToOneField( "ModelA", on_delete=models.CASCADE, related_name="one_to_one_related", )
    one_to_one_field_nullable = models.OneToOneField( "ModelA", on_delete=models.CASCADE, null=True, blank=True, related_name="one_to_one_nullable_related", )
    one_to_one_field_with_description = models.OneToOneField( "ModelA", on_delete=models.CASCADE, related_name="one_to_one_with_description_related", help_text="one_to_one_field_with_description" )
    one_to_one_field_without_related_name = models.OneToOneField( "ModelA", on_delete=models.CASCADE, related_name="+" )

    many_to_many_field_required = models.ManyToManyField( "ModelA", related_name="many_to_many_related" )
    many_to_many_field_nullable = models.ManyToManyField( "ModelA", blank=True, related_name="many_to_many_nullable_related" )
    many_to_many_field_with_description = models.ManyToManyField( "ModelA", related_name="many_to_many_with_description_related", help_text="many_to_many_field_with_description" )
    many_to_many_field_without_related_name = models.ManyToManyField( "ModelA", related_name="+" )

    content_type = models.ForeignKey( ContentType, on_delete=models.CASCADE, help_text='The content type', null=True, blank=True ) #TODO: limit_choices_to={'model__in': ('nameModel')},
    object_id = models.PositiveIntegerField( help_text='The object id', null=True, blank=True )
    
    generic_foreign_key_field = GenericForeignKey( 'content_type', 'object_id' )
    generic_relation_field = GenericRelation( 'ModelA', related_query_name='generic_relation_related' )
...
class ModelB(models.Model):
    foreign_key_field = models.ForeignKey( "ModelA", on_delete=models.CASCADE, related_name="foreign_key_B_related" )
    one_to_one_field = models.OneToOneField( "ModelA", on_delete=models.CASCADE, related_name="one_to_one_B_related" )
    many_to_many_field = models.ManyToManyField( "ModelA", related_name="many_to_many_B_related" )
...
class ModelE(models.Model):
    fk_f = models.ForeignKey("ModelF", on_delete=models.CASCADE, related_name="fk_f_related")
    oto_f = models.OneToOneField("ModelF", on_delete=models.CASCADE, related_name="oto_f_related")
