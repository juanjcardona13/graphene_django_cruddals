...
class CruddalsModelTestGenerateSchemaA(CruddalsModel):
    class Meta:
        model = ModelTestGenerateSchemaA


schema = CruddalsModelTestGenerateSchemaA.schema

Query = CruddalsModelTestGenerateSchemaA.Query
Mutation = CruddalsModelTestGenerateSchemaA.Mutation
