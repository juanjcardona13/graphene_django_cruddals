    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "binary_field_nullable",
                    models.BinaryField(blank=True, editable=True, null=True),
                ),
                (
                    "binary_field_with_default",
                    models.BinaryField(default=b"\x08", editable=True),
                ),
                (
                    "binary_field_with_description",
                    models.BinaryField(
                        editable=True, help_text="binary_field_with_description"
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(help_text="boolean_field_with_description"),
                ),
                ("char_field_required", models.CharField(max_length=100)),
                (
                    "char_field_not_editable",
                ...
                (
                    ...
                    models.CharField(default="char_field_with_default", max_length=100),
                ),
                (
                    "char_field_with_description",
                    models.CharField(
                        help_text="char_field_with_description", max_length=100
                    ),
                ),
                (
                    "choice_field_required",
                    models.CharField(choices=[("a", "A"), ("b", "B")], max_length=100),
                ),
                (
                    "choice_field_not_editable",
                    models.CharField(
                        choices=[("a", "A"), ("b", "B")], editable=False, max_length=100
                    ),
                ),
                (
                    "choice_field_nullable",
                    models.CharField(
                        blank=True,
                        choices=[("a", "A"), ("b", "B")],
                        max_length=100,
                ...
                (
                    "choice_field_with_default",
                    models.CharField(
                        choices=[("a", "A"), ("b", "B")], default="a", max_length=100
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateField(help_text="date_field_with_description"),
                ),
                ("date_time_field_required", models.DateTimeField()),
                ("date_time_field_not_editable", models.DateTimeField(editable=False)),
                (
                    "date_time_field_nullable",
                    models.DateTimeField(blank=True, null=True),
                ),
                (
                    "date_time_field_with_default",
                    models.DateTimeField(auto_now_add=True),
                ),
                (
                    "date_time_field_with_description",
                    models.DateTimeField(help_text="date_time_field_with_description"),
                ),
                ...
                (
                    ...
                    models.TimeField(help_text="time_field_with_description"),
                ),
                (
                    "decimal_field_required",
                    models.DecimalField(decimal_places=2, max_digits=10),
                ),
                (
                    "decimal_field_not_editable",
                    models.DecimalField(
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="decimal_field_with_description",
                        max_digits=10,
                    ),
                ),
                ...
                (
                    "duration_field_nullable",
                    models.DurationField(blank=True, null=True),
                ),
                (
                    "duration_field_with_default",
                    models.DurationField(default=datetime.timedelta),
                ),
                (
                    "duration_field_with_description",
                    models.DurationField(help_text="duration_field_with_description"),
                ),
                ("email_field_required", models.EmailField(max_length=254)),
                (
                    "email_field_not_editable",
                    models.EmailField(editable=False, max_length=254),
                ),
                (
                    "email_field_nullable",
                    models.EmailField(blank=True, max_length=254, null=True),
                ),
                (
                    "email_field_with_default",
                    models.EmailField(
                        default="emailField@withDefault.com", max_length=254
                    ),
                ),
                (
                    "email_field_with_description",
                    models.EmailField(
                        help_text="email_field_with_description", max_length=254
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(help_text="float_field_with_description"),
                ),
                ...
                (
                    ...
                    models.IntegerField(help_text="integer_field_with_description"),
                ),
                ("small_integer_field_required", models.SmallIntegerField()),
                (
                    "small_integer_field_not_editable",
                    models.SmallIntegerField(editable=False),
                ),
                (
                    "small_integer_field_nullable",
                    models.SmallIntegerField(blank=True, null=True),
                ),
                (
                    "small_integer_field_with_default",
                ...
                (
                    "positive_integer_field_not_editable",
                    models.PositiveIntegerField(editable=False),
                ),
                (
                    "positive_integer_field_nullable",
                    models.PositiveIntegerField(blank=True, null=True),
                ),
                (
                    "positive_integer_field_with_default",
                ...
                (
                    "slug_field_with_default",
                    models.SlugField(default="slug_field_with_default"),
                ),
                (
                    "slug_field_with_description",
                    models.SlugField(help_text="slug_field_with_description"),
                ),
                ...
                (
                    "text_field_with_default",
                    models.TextField(default="text_field_with_default"),
                ),
                (
                    "text_field_with_description",
                    models.TextField(help_text="text_field_with_description"),
                ),
                ...
                (
                    "url_field_with_default",
                    models.URLField(default="https://url_field_with_default.com"),
                ),
                (
                    "url_field_with_description",
                    models.URLField(help_text="url_field_with_description"),
                ),
                ...
                (
                    ...
                    models.UUIDField(help_text="uuid_field_with_description"),
                ),
                (
                    "object_id",
                    models.PositiveIntegerField(
                        blank=True, help_text="The object id", null=True
                    ),
                ),
                (
                    "content_type",
                ...
                (
                    "many_to_many_field_nullable",
                    models.ManyToManyField(
                        blank=True,
                        related_name="many_to_many_nullable_related",
                        to="simpleCruddalsModel.ModelA",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="_simpleCruddalsModel_modela_many_to_many_field_without_related_name_+",
                        to="simpleCruddalsModel.ModelA",
                    ),
                ),
                (
                    "one_to_one_field_nullable",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="fk_f_related",
                        to="simpleCruddalsModel.modelf",
                    ),
                ),
                (
                    "mtm_f",
                    models.ManyToManyField(
                        related_name="mtm_f_related", to="simpleCruddalsModel.ModelF"
                    ),
                ),
                (
                    "oto_f",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "many_to_many_field",
                    models.ManyToManyField(
                        related_name="many_to_many_B_related",
                        to="simpleCruddalsModel.ModelA",
                    ),
                ),
                (
