...
class ModelA(models.Model):
    ...
    positive_small_integer_field_not_editable = models.PositiveSmallIntegerField(
        editable=False
    )
    positive_small_integer_field_nullable = models.PositiveSmallIntegerField(
        null=True, blank=True
    )
    positive_small_integer_field_with_default = models.PositiveSmallIntegerField(
        default=0
    )
    positive_small_integer_field_with_description = models.PositiveSmallIntegerField(
        help_text="positive_small_integer_field_with_description"
    )

    big_integer_field_required = models.BigIntegerField()
    big_integer_field_not_editable = models.BigIntegerField(editable=False)
    big_integer_field_nullable = models.BigIntegerField(null=True, blank=True)
    big_integer_field_with_default = models.BigIntegerField(default=0)
    big_integer_field_with_description = models.BigIntegerField(
        help_text="big_integer_field_with_description"
    )

    positive_big_integer_field_required = models.PositiveBigIntegerField()
    positive_big_integer_field_not_editable = models.PositiveBigIntegerField(
        editable=False
    )
    positive_big_integer_field_nullable = models.PositiveBigIntegerField(
        null=True, blank=True
    )
    positive_big_integer_field_with_default = models.PositiveBigIntegerField(default=0)
    positive_big_integer_field_with_description = models.PositiveBigIntegerField(
        help_text="positive_big_integer_field_with_description"
    )
    ...
    generic_ip_address_field_required = models.GenericIPAddressField()
    generic_ip_address_field_not_editable = models.GenericIPAddressField(editable=False)
    generic_ip_address_field_nullable = models.GenericIPAddressField(
        null=True, blank=True
    )
    generic_ip_address_field_with_default = models.GenericIPAddressField(
        default="127.0.0.1"
    )

    ip_address_field_required = models.IPAddressField()
    ip_address_field_not_editable = models.IPAddressField(editable=False)
    ip_address_field_nullable = models.IPAddressField(null=True, blank=True)
    ip_address_field_with_default = models.IPAddressField(default="127.0.0.1")

    # file_path_field_required = models.FilePathField()
    # file_path_field_not_editable = models.FilePathField(editable=False)
    # file_path_field_nullable = models.FilePathField(null=True, blank=True)
    # file_path_field_with_default = models.FilePathField(
    #     path="/path/to/file", default="/path/to/file"
    # )

    # image_field_required = models.ImageField()
    # image_field_not_editable = models.ImageField(editable=False)
    # image_field_nullable = models.ImageField(null=True, blank=True)
    # image_field_with_default = models.ImageField(default="image_field_with_default")
    # image_field_with_description = models.ImageField(
    #     help_text="image_field_with_description"
    # )

    # file_field_required = models.FileField()
    # file_field_not_editable = models.FileField(editable=False)
    # file_field_nullable = models.FileField(null=True, blank=True)
    # file_field_with_default = models.FileField(default="file_field_with_default")
    # file_field_with_description = models.FileField(
    #     help_text="file_field_with_description"
    # )
...
class ModelH(models.Model):
    name = models.CharField(max_length=100, blank=True)
    foreign_key_field = models.ForeignKey(
        "ModelG",
        on_delete=models.CASCADE,
        related_name="foreign_key_h_related",
        null=True,
        blank=True,
    )
    ct_field_custom = models.ForeignKey(
        ContentType,
    ...
    fk_field_custom = models.PositiveIntegerField(null=True, blank=True)
    generic_foreign_key = GenericForeignKey("ct_field_custom", "fk_field_custom")
    one_to_one_field = models.OneToOneField(
        "ModelG",
        on_delete=models.CASCADE,
        related_name="one_to_one_h_related",
        null=True,
        blank=True,
    )
    many_to_many_field = models.ManyToManyField(
        "ModelG",
        related_name="many_to_many_h_related",
        blank=True,
    )
